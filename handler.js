...
export async function handler(chatUpdate) {
    ...
    global.img = 'https://telegra.ph/file/4512d32ecf798940e4081.jpg' 
...
let fkon = { key: { fromMe: false, participant: `${m.sender.split`@`[0]}@s.whatsapp.net`, ...(m.chat ? { remoteJid: '6283842204546@s.whatsapp.net' } : {}) }, message: { contactMessage: { displayName: `${name}`, vcard: `BEGIN:VCARD\nVERSION:3.0\nN:;a,;;;\nFN:${name}\nitem1.TEL;waid=${m.sender.split('@')[0]}:${m.sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`}}}
  let nyaww = 'https://telegra.ph/file/6239d94fe0b72cd67cd79.jpg'
  let fotodaftar = 'https://telegra.ph/file/797a739c1f676d91b7d38.jpg'
let msg = {
