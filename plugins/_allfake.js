...
handler.all = async function (m) {
	...
	try {
		...
		global.kontak2 = [
         [owner[0], await conn.getName(owner[0] + '6283842204546@s.whatsapp.net'), 'YUDAMODS', 'https://yudamods.github.io', true], // Kalo mau di tambah tinggal copy 1baris ini di tempel di bawahnya trs di edit dikit!
        ]
		...
		global.adReply = {
			contextInfo: {
				...
				externalAdReply: { // Bagian ini sesuka kalian berkreasi :'v
					...
					mediaUrl: sgc,
					description: 'YUDAMODS - MD',
					previewType: "PHOTO",
					thumbnail: await (await fetch(pp)).buffer(),
					sourceUrl: "https://yudamods.github.io",					
				}
			}
		}
		global.fakeig = {
        ...
        global.fvn = {
            ...
            { remoteJid: "6283842204546-1625305606@g.us" } : {}) 
                       },
            message: { 
               "audioMessage": {
       ...
       key: {
                   fromMe: false,
                   participant: `0@s.whatsapp.net`, ...(m.chat ? { remoteJid: "6283842204546@s.whatsapp.net" } : {})
               },
               message: {
                   "productMessage": {
                       "product": {
           ...
           "message": {
               "groupInviteMessage": {
                   "groupJid": "6283842204546-1625305606@g.us",
                   "inviteCode": "null",
